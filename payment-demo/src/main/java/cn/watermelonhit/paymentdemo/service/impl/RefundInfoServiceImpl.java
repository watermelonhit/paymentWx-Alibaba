...
import cn.watermelonhit.paymentdemo.mapper.RefundInfoMapper;
...
public class RefundInfoServiceImpl extends ServiceImpl<RefundInfoMapper, RefundInfo> implements RefundInfoService {
    ...
    public RefundInfo createRefundByOrderNo(String orderNo, String reason) {
        ...
        //根据订单号获取订单信息
        OrderInfo orderInfo = this.orderInfoService.getOrderByOrderNo(orderNo);
    ...
    public void updateRefund(String content) {
        ...
        //更新退款单
        this.baseMapper.update(refundInfo, queryWrapper);
    }
    ...
    public List<RefundInfo> getNoRefundOrderByDuration(int minutes) {
        ...
        List<RefundInfo> refundInfoList = this.baseMapper.selectList(queryWrapper);
